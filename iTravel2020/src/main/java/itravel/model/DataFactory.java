...
public class DataFactory {
    ...
    private static void initUsersData (){
        instance.getUserList().add(new User("userId001", "user", "Guta Fida", "M", "IA", "Fairfield", "1000 N 4th", "52557", 1990, "user", "user"));
        instance.getUserList().add(new User("userId002", "admin", "Guta Fida", "M", "IA", "Fairfield", "1000 N 4th", "52557", 1990, "admin", "admin"));
